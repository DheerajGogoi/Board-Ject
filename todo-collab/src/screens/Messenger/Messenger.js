...
const DisplayProfile = () => {
    return(
        <div>
            <Avatar alt="Remy Sharp" src="https://source.unsplash.com/random" style={{
                height: '100px',
                width: '100px',
            }} />
        </div>
                        ...
                        <div className='display-chats'>
                            {
                                messages.map((m, index)=>{
                                    return <div key={index} ref={scrollRef}><DisplayChat message={m} own={m.sender === current_user.email}/></div>
                                })
                            }
                        </div>
